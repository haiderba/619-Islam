...
const SplashScreen: React.FC<SplashScreenProps> = ({ message, onComplete }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[56%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-amber-500/25 rounded-full blur-3xl pointer-events-none animate-pulse" />
      ...
      {/* 🚪 Logo Video Positioned Directly in Center of the Illuminated Mosque Door */}
      <div className="absolute top-[56%] sm:top-[58%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center justify-center w-full max-w-xs px-4">
        {/* Glowing Door Halo */}
        <div className="relative flex items-center justify-center">
          <div className="absolute -inset-3 bg-gradient-to-r from-amber-500/40 via-amber-400/50 to-amber-500/40 rounded-[28%] blur-xl opacity-90 animate-pulse pointer-events-none" />

          {/* Video Container Cropped with Zero White Corners */}
          <div className="relative w-44 h-44 sm:w-52 sm:h-52 rounded-[24%] overflow-hidden shadow-2xl border border-amber-400/50 bg-[#062426] ring-2 ring-amber-400/30">
            <video
              ref={videoRef}
        ...
        {/* Brand Text Below the Mosque Archway */}
        <div className="text-center mt-3 space-y-0.5">
          <h1 className="text-xl sm:text-2xl font-black font-arabic text-amber-300 tracking-wide drop-shadow-md">
            ٦١٩ إِسْلَام
          </h1>
          <p className="text-[11px] text-white/80 font-medium tracking-wider drop-shadow">
