...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="w-full space-y-4 sm:space-y-5">
      ...
      {/* 🌟 1. Master Multi-Date & Location Banner */}
      ...
      {/* 🌟 2. Explore Features Grid (Prominently Placed Above Progress & Habits) */}
      ...
      {/* 🌟 4. Daily Quran Ayah Banner */}
      <DailyAyahCard />

      {/* 🌟 5. Today's Habits Section (At the Bottom) */}
      <div className="bg-card/75 dark:bg-[#062426]/75 backdrop-blur-xl border border-border/80 dark:border-amber-500/20 rounded-3xl p-4 sm:p-5 shadow-sm space-y-3">
        <div className="flex items-center justify-between">
